"""shawards_project URL Configuration
...
urlpatterns = [
    ...
    path('password-reset-complete/', auth_views.PasswordResetCompleteView.as_view(template_name='users/password_reset-complete.html'), name='password-reset-complete'),
